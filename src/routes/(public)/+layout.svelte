...
<div class="flex flex-col min-h-screen">
	...
	>
		...
		<!-- Mobile Menu -->
		{#if mobileMenuOpen}
			<div class="md:hidden bg-white shadow-lg absolute w-full" transition:fade={{ duration: 200 }}>
			...
			<div class="grid grid-cols-1 md:grid-cols-4 gap-8">
				...
				<div class="col-span-1 md:col-span-1">
					...
					<p class="text-gray-400 mb-4">
						Transforming logistics in Ethiopia with innovative solutions and reliable service.
					</p>
				...
				<div>
					...
					<ul class="space-y-2">
						...
						<li>
							<a href="/about" class="text-gray-400 hover:text-white transition-colors duration-300"
								>About Us</a
							>
						</li>
						<li>
					...
					<ul class="space-y-2">
						...
						<li>
							<a
								...
								class="text-gray-400 hover:text-white transition-colors duration-300">Warehousing</a
							>
						</li>
						<li>
							<a
				...
				<div>
					...
					<ul class="space-y-2">
						...
						<li class="flex items-start space-x-3">
							...
							<span class="text-gray-400">info@behulum.com</span>
						</li>
						<li class="flex items-start space-x-3">
							<svg
								xmlns="http://www.w3.org/2000/svg"
