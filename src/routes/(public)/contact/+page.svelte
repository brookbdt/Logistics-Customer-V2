...
<svelte:head>
  <title>Contact Us | Behulum Logistics</title>
  <meta
    name="description"
    content="Contact Behulum Logistics for premium logistics services in Ethiopia. Get in touch with our team for quotes, support, or partnership opportunities."
  />
</svelte:head>
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto text-center">
      ...
      <p class="text-lg md:text-xl text-gray-700 mb-8">
        Have questions about our services? Ready to optimize your logistics? Our
        ...
        >
          ...
          <div>
            ...
            <select
              id="service"
              name="service"
              bind:value={$contactForm.service}
              {...$constraints.service}
              class="w-full px-4 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-primary focus:border-primary"
            >
          ...
          <button
            type="submit"
            class="w-full bg-primary hover:bg-primary-dark text-white py-3 px-6 rounded-md transition-colors duration-300 font-medium flex justify-center items-center"
            disabled={$submitting}
          >
            {#if $submitting}
              <svg
        ...
        <div class="space-y-8">
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-gray-700">Bole Road, Addis Ababa</p>
              <p class="text-gray-700">Ethiopia</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-gray-700">logistics@behulum.com</p>
              <p class="text-gray-700">support@behulum.com</p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-gray-700">+251 91 876 5432</p>
            </div>
          </div>
  ...
  <div class="container mx-auto px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto text-center mb-12">
      ...
      <p class="text-lg text-gray-700">
        Our headquarters is conveniently located in the heart of Addis Ababa.
      </p>
    </div>
    ...
    <div class="h-96 rounded-lg overflow-hidden shadow-xl">
      ...
      <div class="w-full h-full bg-gray-300 flex items-center justify-center">
        <p class="text-gray-600">Map Placeholder - Embed Google Maps here</p>
      </div>
    </div>
  </div>
</section>
