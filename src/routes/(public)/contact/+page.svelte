	...
	<div class="container mx-auto px-4 sm:px-6 lg:px-8">
		<div class="max-w-4xl mx-auto text-center">
			...
			<p class="text-lg md:text-xl text-gray-700 mb-8">
				Have questions about our services? Ready to optimize your logistics? Our team is here to
				help.
			</p>
		</div>
	</div>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
			...
			<div class="bg-white rounded-lg shadow-xl p-8 border border-gray-100">
				...
				<form on:submit|preventDefault={handleSubmit} class="space-y-6">
					...
					<button
						type="submit"
						class="w-full bg-primary hover:bg-primary-dark text-white py-3 px-6 rounded-md transition-colors duration-300 font-medium"
					>
						Send Message
					</button>
				</form>
				...
				<div class="space-y-8">
					...
					<div class="flex items-start space-x-4">
						...
						<div>
							...
							<p class="text-gray-700">info@behulum.com</p>
